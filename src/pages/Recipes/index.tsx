  ...
  return (
    <>
      <PageSEO
        ...
        description="Recipes using Divya Foods premium imports — seafood, Japanese, curries, grilled dishes and more. Garlic butter salmon, crispy calamari, coconut prawn curry and more."
      />
